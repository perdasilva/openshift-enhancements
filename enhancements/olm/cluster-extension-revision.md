...
tracking-link: # link to the tracking ticket (for example: Jira Feature or Epic ticket) that corresponds to this enhancement
  - https://issues.redhat.com/browse/OPRUN-4002
---

# Adopt Boxcutter Library

## Summary

This enhancement proposes fundamentally changing the way OLMv1 life-cycles applications by introducing the 
ClusterExtensionRevision API that describes the manifests and rollout

## Motivation

**Object Status Reporting**
Gather status information from object conditions or other status fields.

**Phased Rollout And Teardown**
Allows to customize the order-of-operations of the reconciler.
e.g.: Create RBAC and CRDs before creating Deployment, Teardown Deployment before RBAC and CRDs.

**Resource Orphaning And Adoption**
Allows removal of objects from control of the library and adoption of already existing objects, to support migrations.

**Anomaly And Interference Detection**
The library outputs detailed information during reconciliation, allowing the detection of other actors in a system updating the same resource.

**Rollout History**
Boxcutter keeps a rollout history allowing administrators to look up bundle changes and facilitates rollback to previously working releases.
